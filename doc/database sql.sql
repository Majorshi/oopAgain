...
CREATE TABLE IF NOT EXISTS `wt_users_extradata` (
    ...
    `user_idno` varchar(32) NULL COMMENT '身份证号或工号',
...
CREATE TABLE IF NOT EXISTS `wt_paper` (
    ...
    `paper_abstract` text DEFAULT NULL COMMENT '论文摘要',
...
CREATE TABLE IF NOT EXISTS `wt_paper_blind` (
    ...
    `blind_remark` text DEFAULT NULL COMMENT '修改说明',
    `blind_review` text DEFAULT NULL COMMENT '学术评语',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '论文盲审预设结果' AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `wt_paper_edit` (
    ...
    `paper_id` int(11) NOT NULL COMMENT '论文ID',
    `uid` int(11) NOT NULL COMMENT '专家ID',
    `edit_remark` text DEFAULT NULL COMMENT '修改说明',
    `blind_res` int(4) DEFAULT 0 COMMENT '审核修改结果ID',
    `blind_remark` text DEFAULT NULL COMMENT '对修改结果评价说明',
...
CREATE TABLE IF NOT EXISTS `wt_paper_check` (
    ...
    `blind_res` text DEFAULT NULL COMMENT 'JSON字符串，专家评审结果',
    `edit_res` text DEFAULT NULL COMMENT 'JSON字符串，论文修改结果',
