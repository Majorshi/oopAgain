<div class="col-xs-9 mt100">
	...
	<form method="post" action="/paperevalu/app/academyRemark.php">
		...
		<div class="form-group">
	    	<label>申请理由：</label>
	    	<p style="min-height:100px">我已获得软件工程硕士培养计划中规定的全部学分,并完成了学位论文的 撰写工作。现申请进行学位论文评审,请审批。</p>
		</div>
		<div class="form-group">
	    	<label>导师意见：</label>
	    	<p style="min-height:100px"><?php echo $paperdata['tutor_opinion']; ?></p>
		</div>
		<div class="form-group">
	    	<label>学院意见：</label>
	    	<textarea required="required" name="inst_opinion" class="form-control" placeholder="请填写学院意见" style="height:200px"></textarea>
		</div>
		<label class="radio">
		  <input type="radio" name="agree" id="inlineRadio2" value="1" checked> 同意申请
		</label>
		<label class="radio">
		  <input type="radio" name="agree" id="inlineRadio3" value="0"> 驳回申请
		</label>
